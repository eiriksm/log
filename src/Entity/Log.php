 ...
 *
 *     "form" = {
 *       "default" = "Drupal\log\Entity\Form\LogForm",
 *       "add" = "Drupal\log\Entity\Form\LogForm",
 *       "edit" = "Drupal\log\Entity\Form\LogForm",
 *       "delete" = "Drupal\log\Entity\Form\LogDeleteForm",
 *     },
 *     "access" = "Drupal\log\LogAccessControlHandler",
 *   },
 *   base_table = "log",
 *   data_table = "log_field_data",
 *   admin_permission = "administer Log entity",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 *     "uuid" = "uuid"
 *   },
 *   links = {
 *     "canonical" = "/admin/log/{log}",
 *     "edit-form" = "/admin/log/{log}/edit",
 *     "delete-form" = "/admin/log/{log}/delete"
 *   },
 *   field_ui_base_route = "log.settings",
